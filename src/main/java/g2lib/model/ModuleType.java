...
public enum ModuleType {
    ...
    (1, "Keyboard", 2,
     ModPage.InOut.ix(5),
     List.of(),
     List.of(Port.out("Pitch",Blue,2,1),
    ...
    (15, "Switch 8-1", 4,
     ModPage.Switch.ix(5),
     List.of(Port.in("In1",Blue_red,6,0),
     ...
     List.of(Port.out("Out",Blue_red,19,3),
    ...
    (20, "Envelop ADSR", 4,
     ...
     List.of(Port.in("In",Blue_red,19,0),
             ...
             Port.in("AM",Blue,0,3)),
     List.of(Port.out("Env",Blue,18,3),
    ...
    (23, "Envelope Modulation ADSR", 5,
     ...
     List.of(Port.in("Gate",Yellow,0,4),
             ...
             Port.in("AM",Blue,0,4)),
     List.of(Port.out("Env",Blue,19,4),
    ...
    (25, "LFO Shape A", 5,
     ...
     List.of(Port.out("Out",Blue,19,4),
    ...
    (41, "Envelope Hold", 2,
     ...
     List.of(Port.out("Env",Blue,15,1),
    ...
    (46, "Envelope AHD", 4,
     ...
     List.of(Port.in("Trig",Yellow,0,2),
             Port.in("AM",Blue,0,3),
             Port.in("In",Blue_red,19,0)),
     List.of(Port.out("Env",Blue,18,0),
    ...
    (48, "Mixer Stereo", 5,
     ...
     List.of(Port.out("OutL",Blue_red,17,4),
    ...
    (52, "Envelope Multi", 6,
     ...
     List.of(Port.in("Gate",Yellow,0,2),
             ...
             Port.in("AM",Blue,2,2)),
     List.of(Port.out("Env",Blue,19,1),
             Port.out("Out",Blue_red,19,0)),
    ...
    (84, "Envelope ADR", 3,
     ...
     List.of(Port.in("Gate",Yellow,0,2),
             Port.in("In",Blue_red,19,0),
             Port.in("AM",Blue,3,2)),
     List.of(Port.out("Env",Blue,17,2),
    ...
    (91, "Flip Flop", 2,
     ...
     List.of(Port.in("Clk",Yellow_orange,8,1),
             ...
             Port.in("Rst",Yellow_orange,5,1)),
     List.of(Port.out("NotQ",Yellow_orange,17,1),
    ...
    (119, "Envelope ADDSR", 5,
     ...
     List.of(Port.in("Gate",Yellow,0,2),
             Port.in("AM",Blue,0,3),
             Port.in("In",Blue_red,19,0)),
     List.of(Port.out("Env",Blue,17,3),
             Port.out("Out",Blue_red,19,3)),
    ...
    (121, "Sequencer Note", 9,
     ...
     List.of(Port.out("Link",Yellow_orange,19,1),
    ...
    (140, "Mixer 4-1 Stereo", 4,
     ...
     List.of(Port.out("OutL",Blue_red,17,3),
    ...
    (144, "Seq Event", 5,
     ...
     List.of(Port.out("Link",Yellow,19,1),
    ...
    (150, "Compressor", 5,
     ...
     List.of(Port.out("OutR",Red,18,4),
    ...
    (154, "Sequencer Controlled", 8,
     ...
     List.of(Port.in("Ctrl",Blue_red,0,1),
             Port.in("Val",Blue_red,0,5),
             Port.in("Trig",Yellow_orange,0,7)),
     List.of(Port.out("Val",Blue_red,19,5),
             Port.out("Trig",Yellow_orange,19,7)),
     List.of(ModParam.LevBipUni.mk("Seq1Step1"),
             ModParam.LevBipUni.mk("Seq1Step2"),
             ModParam.LevBipUni.mk("Seq1Step3"),
    ...
    (161, "Mixer 8-1 Fader", 9,
     ...
     List.of(Port.in("In1",Blue_red,1,1),
             ...
             Port.in("In8",Blue_red,17,1),
             Port.in("Chain",Blue_red,19,0)),
     List.of(Port.out("Out",Blue_red,19,8)),
     List.of(ModParam.MixLevel.mk("Lev1"),
             ModParam.MixLevel.mk("Lev2"),
             ModParam.MixLevel.mk("Lev3"),
             ModParam.MixLevel.mk("Lev4"),
    ...
    (169, "Envelope Modulation AHD", 5,
     ...
     List.of(Port.in("Trig",Yellow,0,2),
             ...
             Port.in("In",Blue_red,19,0),
             Port.in("AM",Blue,0,4)),
     List.of(Port.out("Env",Blue,18,4),
    ...
    (174, "Delay Dual", 3,
     ...
     List.of(Port.out("Out1",Red,10,2),
    ...
    (175, "Delay Quad", 5,
     ...
     List.of(Port.out("OutMain",Red,19,4),
    ...
    (179, "Shift Register", 2,
     ModPage.Delay.ix(5),
     List.of(Port.in("In",Blue_red,5,1),
             Port.in("Clk",Yellow_orange,0,1)),
     List.of(Port.out("Out1",Blue_red,7,1),
             Port.out("Out2",Blue_red,9,1),
             Port.out("Out3",Blue_red,11,1),
    ...
    (180, "FM Operator", 12,
     ...
     List.of(Port.in("Freq",Blue,0,3),
             ...
             Port.in("Pitch",Blue,0,1)),
     List.of(Port.out("Out",Red,19,11)),
    ...
    (185, "Mixer 1-1 Stereo", 2,
     ...
     List.of(Port.out("OutL",Blue_red,17,1),
             Port.out("OutR",Blue_red,19,1)),
     List.of(ModParam.MixLevel.mk("Lev"),
    ...
    (190, "LFO B", 4,
     ...
     List.of(Port.out("Out",Blue,19,3),
    ...
    (198, "Pitch Tracker", 2,
     ModPage.Note.ix(5),
     List.of(Port.in("In",Blue_red,0,1)),
     List.of(Port.out("Period",Yellow_orange,13,1),
    ...
    (204, "Random Clock A", 2,
     ...
     List.of(Port.out("Out",Blue_red,19,1)),
     List.of(ModParam.Level_100.mk("StepProb"),
             ModParam.PolyMono.mk("PolyMono"),
