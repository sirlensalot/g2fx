...
public class ParameterOverview {
    ...
    public ParameterOverview() {
        HBox buttonBar = withClass1("ppage-button-bar", new HBox(
                spacer(),
                withClass1("ppage-button", unfocusable(new Button("Assign MIDI"))),
                withClass1("ppage-button", unfocusable(new Button("Clear MIDI"))),
                withClass1("ppage-tbutton",unfocusable(new ToggleButton("View MIDI"))),
                withClass1("ppage-tbutton",unfocusable(new ToggleButton("View Buttons"))),
                withClass1("ppage-tbutton",unfocusable(new ToggleButton("Global Pages")))));
                        ...
                        withClass1("ppage-block-box",addChildren(new VBox(), IntStream.rangeClosed(1,3).mapToObj(i ->
                                {
                                    ...
                                    return withClass1("ppage-row", addChildren(
                                            ...
                                            IntStream.range(0,8).mapToObj(j ->
                                                FXUtil.withClass(new VBox(
                                                        withClass(label(""),"ppage-pname"),
                                                        withClass(label(""),"ppage-pvalue","module-text-field")),
                                                        "ppage-box",
