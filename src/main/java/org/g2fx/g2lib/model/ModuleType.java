...
public enum ModuleType {
    ...
    (161, "Mixer 8-1 Fader", 9,
     ...
     List.of(ModParam.MixLevel.mk("Lev1",8),
             ModParam.MixLevel.mk("Lev2",9),
             ModParam.MixLevel.mk("Lev3",10),
             ModParam.MixLevel.mk("Lev4",11),
             ModParam.MixLevel.mk("Lev5",12),
             ModParam.MixLevel.mk("Lev6",13),
             ModParam.MixLevel.mk("Lev7",14),
             ModParam.MixLevel.mk("Lev8",15),
             ModParam.OffOn.mk("On1").label("Ch 1"),
             ModParam.OffOn.mk("On2").label("Ch 2"),
             ModParam.OffOn.mk("On3").label("Ch 3"),
             ModParam.OffOn.mk("On4").label("Ch 4"),
    ...
    (194, "Mixer 2-1 A", 2,
     ModPage.Mixer.ix(2), false,
            List.of(in("In1",Blue_red,9,1),
             ...
             in("Chain",Blue_red,0,1)),
     List.of(out("Out",Blue_red,19,1)),
     List.of(ModParam.MixLevel.mk("Lev1",1),
             ModParam.OffOn.mk("On1").label("Ch 1"),
             ModParam.MixLevel.mk("Lev2",3),
             ModParam.OffOn.mk("On2").label("Ch 2"),
             ModParam.ExpLin_2.mk("ExpLin")),
     List.of()),
    M_ModAmt
